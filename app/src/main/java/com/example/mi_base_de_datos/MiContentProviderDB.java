...
public class MiContentProviderDB extends ContentProvider {
    ...
    static {
        uriMatcher.addURI("com.brian.mibasedatosp77b.provider", "contactos", 1);

        uriMatcher.addURI("com.brian.mibasedatosp77b.provider", "contactos/#", 2);

        uriMatcher.addURI("com.brian.mibasedatosp77b.provider", "contactos/*", 3);
    }
